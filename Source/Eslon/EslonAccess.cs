...
{
    /// <summary>
    /// Presents a surrogate to <see cref="EslonEngine"/> using <see cref="EslonCanon"/>.
    /// </summary>
    public static class EslonAccess
    {
        ...
        public static EslonEngine Engine
        {
            ...
            set
            {
                if (value.Reader.GetType() != EslonCanon.Reader.GetType())
                {
        ...
        {
            return new EslonEngine(EslonCanon.Reader, EslonCanon.Writer, EslonCanon.AugmentEditors(null), EslonCanon.AugmentReflectors(null), EslonCanon.AugmentConduits(null));
        }
    }
}
